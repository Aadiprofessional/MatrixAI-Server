...
async function executeSQL() {
  try {
    ...
    const sqlContent = fs.readFileSync('create_user_detection_table.sql', 'utf8');
    ...
    try {
      ...
      if (error) {
        ...
        console.log('The user_detection table may not have been created successfully');
      } else {
        console.log('✅ user_detection table exists and is accessible');
